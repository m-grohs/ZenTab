...
import { getFaviconUrl, getDomain } from './utils.js';

// ── Injected callback ─────────────────────────
let _openModal = () => {};
export function setOpenModal(fn) {
	_openModal = fn;
}

// ─────────────────────────────────────────────
//  SVG icons — built with createElementNS, no DOMParser/parseSVG.
//  Stroke/fill are set as direct attributes so they are visible
//  regardless of CSS cascade or currentColor inheritance.
// ─────────────────────────────────────────────

const SVG_NS = 'http://www.w3.org/2000/svg';

// Icon colour — hardcoded so it's always visible regardless of CSS cascade.
const C_ICON = '#c8c8d8';

function _svg(size, children) {
...
const icons = {
	// Three dots — filled circles
	dots: () =>
		_svg(10, [
			['circle', { cx: '5', cy: '12', r: '1.6', fill: C_ICON }],
			['circle', { cx: '12', cy: '12', r: '1.6', fill: C_ICON }],
			['circle', { cx: '19', cy: '12', r: '1.6', fill: C_ICON }]
		]),
	// Pencil — stroked paths
	edit: () =>
		_svg(12, [
			[
				'path',
	...
	del: () =>
		_svg(12, [
			['line', { x1: '18', y1: '6', x2: '6', y2: '18', stroke: C_ICON, 'stroke-width': '2', 'stroke-linecap': 'round' }],
			['line', { x1: '6', y1: '6', x2: '18', y2: '18', stroke: C_ICON, 'stroke-width': '2', 'stroke-linecap': 'round' }]
		])
};
